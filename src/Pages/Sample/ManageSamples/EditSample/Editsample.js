...
function Editsample({ SampleData }) {
  ...
  const formik = useFormik({
    initialValues: {
      date: SampData.date,
      project_id: SampData.project.id,
      source: SampData.source,
      truck_number: SampData.truck_number,
      ticket_number: SampData.ticket_number,
      client_ref: SampData.client_ref,
      client_id: SampData.client.id,
      type: SampData.type,
      type_description: SampData.type_description,
      grade: SampData.grade,
      mix_description: SampData.mix_description,
      cast_date: SampData.cast_date,
      test_date: SampData.test_date,
      age: SampData.age,
    },
