...
import { selectedGridRowsCountSelector } from "@material-ui/x-grid";
const comp3 = React.memo(({ formik, Selection }) => {
  ...
  const getProjects = async (e) => {
    ...
    if (value) {
      let project = Selection.clients.filter(
  ...
  useEffect(() => {
    ...
    getProjects({ target: { value: formik.values.client_id } });
  }, [Selection, formik]);
    ...
    <fieldset>
      ...
      <div style={style.top}>
        ...
        <TextField
          ...
          onChange={formik.handleChange}
          value={formik.values.client_ref}
